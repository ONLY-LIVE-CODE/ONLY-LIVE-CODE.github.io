...
class config extends Admin_Controller {
	...
	public function index()
	{
		...
		if($this->form_validation->run() == TRUE) {
			...
			$data = $this->siteconfig->array_from_post(array('unitpay_status','unitpay_address','site_name','sitedescription','rk_login','rk_status','rk_password1','rk_password2','metadescr','yad_client_id','yad_token','qiwi_num','qiwi_pass','wmid','WMR','WMZ','WMU','WME','wm_pass','site_pwebmoney','site_pqiwi','site_pyandex','site_ppkolvo','primearea','digiid','tags'));
			if($data['wm_pass'] == "******")
