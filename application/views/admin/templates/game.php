...
<? echo form_open_multipart(); ?>
   ...
   <div class="form-group">
                            ...
                            <div class="col-sm-10">
                <? echo form_input('game_fon', set_value('game_fon', $this->config->item('game_fon')),'class="form-control"'); ?>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                           <? echo form_input('game_logo', set_value('game_logo', $this->config->item('game_logo')),'class="form-control"'); ?>
                            </div>
                        </div>
