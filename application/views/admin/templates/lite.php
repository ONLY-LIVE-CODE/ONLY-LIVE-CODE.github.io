...
<? echo form_open_multipart(); ?>
   ...
   <div class="form-group">
                            ...
                            <div class="col-sm-10">
                <? echo form_input('lite_kontakt', set_value('lite_kontakt', $this->config->item('lite_kontakt')),'class="form-control"'); ?>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                           <? echo form_input('lite_logo', set_value('lite_logo', $this->config->item('lite_logo')),'class="form-control"'); ?>
                            </div>
                        </div>
