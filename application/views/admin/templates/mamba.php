...
<? echo form_open_multipart(); ?>
   ...
   <div class="form-group">
                            ...
                            <div class="col-sm-10">
                <? echo form_input('mamba_fon', set_value('mamba_fon', $this->config->item('mamba_fon')),'class="form-control"'); ?>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                           <? echo form_input('mamba_logo', set_value('mamba_logo', $this->config->item('mamba_logo')),'class="form-control"'); ?>
                            </div>
                        </div>
