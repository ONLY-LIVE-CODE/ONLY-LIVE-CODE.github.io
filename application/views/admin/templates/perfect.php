...
<? echo form_open_multipart(); ?>
   ...
   <div class="form-group">
                            ...
                            <div class="col-sm-10">
                <? echo form_input('perfect_fon', set_value('perfect_fon', $this->config->item('perfect_fon')),'class="form-control"'); ?>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                           <? echo form_input('perfect_logo', set_value('perfect_logo', $this->config->item('perfect_logo')),'class="form-control"'); ?>
                            </div>
                        </div>
