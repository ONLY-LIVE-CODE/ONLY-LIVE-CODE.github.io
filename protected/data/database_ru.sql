...
--
-- Host: localhost    Database: vsdesk
-- ------------------------------------------------------
...
/*!40000 ALTER TABLE `CUsers`
    DISABLE KEYS */;
INSERT INTO `CUsers`
VALUES (1, 'admin', 'Администратор', 'b147fdcfe0a8120780ce85a8a6d27596', 'admin@email.com', '+79003113133', '', '6013',
        'vsdeskadmin', 'Администратор', 'Компания А', '', 'ИТ отдел', '', '', 'Администратор', 1, 0, 'ru', 1, 1, '', '',
        NULL, NULL, 'NULL'),
       (2, 'manager', 'Васин В.В.', '9a88fba853317e9496ca33824bda8ba8', 'manager@email.com', '+79005556667', '', '',
        'vsdeskmanager', 'Исполнитель', 'Компания Б', '', 'ИТ отдел', '', '', 'Инженер', 1, 0, 'ru', 1, 1, '', '', NULL,
        NULL, 'NULL'),
       (3, 'user', 'Кузнецов А. С.', '4417e18f1155c1f595e1006aed7d2e27', 'user@email.com', '+79001000000', '', '6023',
        'vsdeskuser', 'Пользователь', 'Компания А', '205', 'Отдел продаж', '', '', 'Менеджер', 1, 0, 'ru', 1, 1, '', '',
        NULL, NULL, 'NULL');
/*!40000 ALTER TABLE `CUsers`
    ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `update_user_name`
    BEFORE UPDATE
    ON `CUsers`
    FOR EACH ROW
    IF (old.`Username` <> new.`Username`) THEN
        UPDATE `request` SET `request`.`CUsers_id` = new.`Username` WHERE `request`.`CUsers_id` = old.`Username`;
...
/*!50003 SET sql_mode = 'NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `update_manager_request`
    AFTER UPDATE
    ON `CUsers`
    FOR EACH ROW
    IF (old.`fullname` <> new.`fullname`) THEN
        UPDATE `request` SET `mfullname` = new.`fullname` WHERE `Managers_id` = old.`Username`;
...
/*!40000 ALTER TABLE `asset`
    DISABLE KEYS */;
INSERT INTO `asset`
VALUES (1, 1, '27.12.2014 14:03', 'ПК Кузнецова', '', 'PC-125987', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '22500', 6, 'Системный блок', 0, 'user', 'Кузнецов А. С.', 'Отдел продаж', '', 'NULL'),
       (2, 1, '27.12.2014 14:04', 'Монитор Кузнецова', '', 'MON-124598', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '7500', 17, 'Монитор', 0, 'user', 'Кузнецов А. С.', 'Отдел продаж', '', 'NULL'),
       (3, 1, '27.12.2014 14:06', 'Logitech Black Keyboard', '', 'KB-125798', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '850', 16, 'Клавиатура', 0, 'user', 'Кузнецов А. С.', 'Отдел продаж', '', 'NULL'),
       (4, 1, '27.12.2014 14:07', 'Logitech Black Mouse', '', 'MOU-156798', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '450', 19, 'Мышь', 0, 'user', 'Кузнецов А. С.', 'Отдел продаж', '', 'NULL'),
       (5, 1, '27.12.2014 14:08', 'Windows 8.1 Pro', '', '', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '8500', 18, 'Операционная система', 0, 'user', 'Кузнецов А. С.', 'Отдел продаж', '', 'NULL');
/*!40000 ALTER TABLE `asset`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `asset_attrib`
    DISABLE KEYS */;
INSERT INTO `asset_attrib`
VALUES (6, 'Системный блок', 0),
       (7, 'Принтер', 0),
       (9, 'Маршрутизатор', 0),
       (13, 'МФУ', 0),
       (14, 'Сервер', 0),
...
/*!40000 ALTER TABLE `asset_attrib_value`
    DISABLE KEYS */;
INSERT INTO `asset_attrib_value`
VALUES (11, 7, 7, 'Модель принтера'),
...
/*!40000 ALTER TABLE `asset_values`
    DISABLE KEYS */;
INSERT INTO `asset_values`
VALUES (219, 1, 6, 'Материнская плата', 'ASUS P8iX-LE'),
       ...
       (236, 2, 17, 'Производитель', 'Samsung');
/*!40000 ALTER TABLE `asset_values`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `astatus`
    DISABLE KEYS */;
INSERT INTO `astatus`
VALUES (1, 'Используется', '#6ac28e',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>'),
       (2, 'Сломан', '#eb5f69',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #eb5f69; vertical-align: baseline; white-space: nowrap; border: 1px solid #eb5f69; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Сломан</span>'),
       (3, 'В ремонте', '#fcb117',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #fcb117; vertical-align: baseline; white-space: nowrap; border: 1px solid #fcb117; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">В ремонте</span>'),
       (4, 'В резерве', '#a39a44',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #a39a44; vertical-align: baseline; white-space: nowrap; border: 1px solid #a39a44; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">В резерве</span>'),
       (5, 'На складе', '#58595b',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #58595b; vertical-align: baseline; white-space: nowrap; border: 1px solid #58595b; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">На складе</span>'),
       (6, 'Списан', '#8b96a6',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #8b96a6; vertical-align: baseline; white-space: nowrap; border: 1px solid #8b96a6; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Списан</span>');
/*!40000 ALTER TABLE `astatus`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `bcats`
    DISABLE KEYS */;
INSERT INTO `bcats`
VALUES (1, 'Проблемы', 'Пользователь,Исполнитель,Гость'),
...
/*!40000 ALTER TABLE `brecords`
    DISABLE KEYS */;
INSERT INTO `brecords`
VALUES (1, 1, 'Проблемы', 'Тестовая запись ', '<p>\n   Тестовый контент<br></p>', 'Администратор', '26.02.2019 18:56',
        '', 'Пользователь,Исполнитель,Гость');
/*!40000 ALTER TABLE `brecords`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `comment_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `comment_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'Компания А', 'Пупкин И.С.', 'Генерального директора', 'Пупкина Игоря Сергеевича',
        'Москва, ул. Пупырина, д.6, кв.777', 'Москва, ул. Пупырина, д.6, кв.777', 'Кузнецов Алексей',
        '+7(999)999-99-99', 'user@email.com', '', '', 'manager', '12345678910', '123456789', '1234567891023', '',
        '045879524', '45678912306547896514', '25112555512658815252', 'email.com', NULL, 'NULL'),
       (2, 'Компания Б', 'Сатья Наделла', '', '', 'Москва', 'Москва', '', '', '', '', '', '', '', '', '', '', '', '',
        '', 'email2.com', NULL, 'NULL');
/*!40000 ALTER TABLE `companies`
    ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client = @@character_set_client */;
...
/*!50003 SET sql_mode = 'NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `company_update_users`
    AFTER UPDATE
    ON `companies`
    FOR EACH ROW
    IF (old.`name` <> new.`name`) THEN
        UPDATE `CUsers` SET `CUsers`.`company` = new.`name` WHERE `CUsers`.`company` = old.`name`;
...
/*!40000 ALTER TABLE `companies_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `companies_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `company_fields`
    DISABLE KEYS */;
INSERT INTO `company_fields`
VALUES (28, 1, 'Дата договора', 'date', '', 6),
       (29, 2, 'Дата договора', 'date', '', 6),
       (30, 1, 'Город', 'select', 'Москва', 7),
       (31, 2, 'Город', 'select', 'Москва', 7);
/*!40000 ALTER TABLE `company_fields`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `company_fieldset`
    DISABLE KEYS */;
INSERT INTO `company_fieldset`
VALUES (6, NULL, 2, 'Дата договора', 'date', 0, NULL, 0),
       (7, NULL, 1, 'Город', 'select', 0,
        'Москва,Санкт-Петербург,Казань,Новосибирск,Екатеринбург,Нижний Новгород,Челябинск,Омск,Самара,Ростов-на-Дону,Уфа,Красноярск,Пермь,Воронеж,Волгоград,Краснодар,Саратов,Тюмень,Тольятти,Ижевск,Барнаул,Ульяновск,Иркутск,Хабаровск,Ярославль,Владивосток,Махачкала,Томск,Оренбург,Кемерово,Новокузнецк,Рязань,Астрахань,Пенза,Липецк,Киров,Чебоксары,Тула,Калининград,Балашиха,Курск,Ставрополь,Улан - Удэ,Севастополь,Тверь,Магнитогорск,Сочи,Иваново,Брянск,Комсомольск-на-Амуре',
        1);
/*!40000 ALTER TABLE `company_fieldset`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `company_services`
    DISABLE KEYS */;
...
VALUES (1, 'ТП0001', 'Договор на техническую поддержку с ООО \"Компания А\"', ' Договор технической поддержки',
        '2019-03-18', '18.03.2019', 1, 'Компания А', 2, 'Компания Б', '2020-03-18', '18.03.2020', 50000, 0, 'NULL');
/*!40000 ALTER TABLE `contracts`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `contracts_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `contracts_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `cunit_types`
    DISABLE KEYS */;
INSERT INTO `cunit_types`
VALUES (1, 'Рабочая станция'),
...
/*!40000 ALTER TABLE `cunits`
    DISABLE KEYS */;
INSERT INTO `cunits`
VALUES (1, 'Рабочее место Кузнецова', 'Рабочая станция', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Используется</span>',
        '39800', 'user', 'Кузнецов А. С.', 'Отдел продаж', 'WS-156798', '27.12.2014 14:05', '27.12.2014', '',
        'Компания А', '5,1,2,3,4', '', '<p>asdsdasdas222</p>', 'NULL');
/*!40000 ALTER TABLE `cunits`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `cunits_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `cunits_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `depart`
    DISABLE KEYS */;
INSERT INTO `depart`
VALUES (1, 'Отдел продаж', 'Компания А', 2, NULL),
       (2, 'ИТ отдел', 'Компания А', 3, NULL),
       (3, 'Руководство', 'Компания А', NULL, 'NULL');
/*!40000 ALTER TABLE `depart`
    ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client = @@character_set_client */;
...
/*!50003 SET sql_mode = 'NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `depart_request_update`
    AFTER UPDATE
    ON `depart`
    FOR EACH ROW
    IF (old.`name` <> new.`name`) THEN
...
/*!40000 ALTER TABLE `depart_services`
    DISABLE KEYS */;
INSERT INTO `depart_services`
VALUES (3, 1);
/*!40000 ALTER TABLE `depart_services`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `fieldsets`
    DISABLE KEYS */;
INSERT INTO `fieldsets`
VALUES (1, 'Выездное обслуживание'),
       (2, 'Электронная почта');
/*!40000 ALTER TABLE `fieldsets`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `fieldsets_fields`
    DISABLE KEYS */;
INSERT INTO `fieldsets_fields`
VALUES (1, 1, 2, 'Требуется выезд', 'toggle', 0, '', 0),
       (2, 1, 3, 'Дата выезда', 'date', 0, '', 0),
       (4, 2, 3, 'Адрес электронной почты', 'textFieldRow', 0, '', 0),
       (8, 2, 2, 'Новый ящик?', 'toggle', 0, NULL, 0),
       (10, 1, 5, 'Город', 'select', 0,
        'Москва,Санкт-Петербург,Казань,Новосибирск,Екатеринбург,Нижний Новгород,Челябинск,Омск,Самара,Ростов-на-Дону,Уфа,Красноярск,Пермь,Воронеж,Волгоград,Краснодар,Саратов,Тюмень,Тольятти,Ижевск,Барнаул,Ульяновск,Иркутск,Хабаровск,Ярославль,Владивосток,Махачкала,Томск,Оренбург,Кемерово,Новокузнецк,Рязань,Астрахань,Пенза,Липецк,Киров,Чебоксары,Тула,Калининград,Балашиха,Курск,Ставрополь,Улан - Удэ,Севастополь,Тверь,Магнитогорск,Сочи,Иваново,Брянск,Комсомольск-на-Амуре',
        1);
/*!40000 ALTER TABLE `fieldsets_fields`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `groups`
    DISABLE KEYS */;
INSERT INTO `groups`
VALUES (1, 'Первая линия поддержки', '2', '2255', 'group@email.com', 0);
/*!40000 ALTER TABLE `groups`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `influence`
    DISABLE KEYS */;
INSERT INTO `influence`
VALUES (1, 'Незначительное влияние', ''),
...
/*!40000 ALTER TABLE `knowledge_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `knowledge_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'default', '[Ticket #{id}] {name}',
       ...
       (16, 'Заявка согласована', '[Ticket #{id}] {name} Заявка согласаована',
        ...
        0),
       (17, 'Заявка открыта повторно', '[Ticket #{id}] {name}',
        '<h3>Заявка № {id} была открыта заказчиком повторно</h3>\n<p>Название заявки:&nbsp;<strong>{name}</strong></p>\n<p>Заказчик:&nbsp;<strong>{fullname}</strong></p>\n<p>Вы должны приступить к работе до&nbsp;<strong>{StartTime}</strong></p>\n<p>Заявка должна быть исполнена до&nbsp;<strong>{EndTime}</strong></p>\n<p>Содержание:</p>\n<p>{content}</p><p>Ссылка на заявку {url}</p>',
        0),
       (18, '{registration}', 'Регистрация в системе vsDesk',
        '<h3>Успешная регистрация в системе технической поддержки продукта vsDesk.</h3>\n<p>Добрый день! Вы успешно зарегистрировались на портале&nbsp;технической поддержки vsDesk, теперь вы можете:</p>\n<ul><li>оставлять заявки на поддержку и обслуживание;</li><li>видеть последние новости компании;</li>\n<li>получать самостоятельную помощь из опубликованных записей Базы знаний;</li></ul>\n<p>Ваш логин в системе: <strong>{login}</strong></p>\n<p>Ваш пароль в системе:<strong> {password}</strong></p>\n<p>Перейдите на портал технической поддержки и начните работу!</p>',
        1),
       (19, 'Заявка приостановлена', '[Ticket #{id}] {name}',
        '<h3>Приостановлена работа над заявкой № {id} \"{name}\"</h3>\n<p>Заявка была приостановлена Исполнителем&nbsp;<strong>{manager_name},&nbsp;</strong>вы можете связаться с Исполнителем по телефону&nbsp;<strong>{manager_phone}</strong></p>\n<p><strong>Содержание заявки:</strong></p>\n<p>{content}</p>\n<p>Ссылка на заявку {url}</p>\n<p><strong>{comment_message}</strong></p><p></p>',
        0),
       (20, '{escalate}', '[Ticket #{id}] {name}',
        '<p>Произошла автоматическая эскалация заявки номер <b>{id}</b>&nbsp;<strong>{name}</strong></p><p>Был назначен новый исполнитель <b>{manager_name}</b>&nbsp;</p><p>Посмотреть заявку&nbsp;{url}</p>',
        2),
       (21, '{comments}', '[Ticket #{id}] {name}',
        '<p><strong>Добавлен новый комментарий:</strong></p><p>{date} {author} написал:&nbsp;</p><p>{comment}</p><p>Посмотреть заявку {url}</p><p>{comments_list}</p>',
        3);
/*!40000 ALTER TABLE `messages`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `news`
    DISABLE KEYS */;
INSERT INTO `news`
VALUES (1, 'Администратор', 'Отключение электропитания c 15-00 до 18-00!',
...
(
    ...
    `email_template`   text         DEFAULT NULL COMMENT 'Шаблон Email сообщения',
    `send_sms`         tinyint(1)   DEFAULT NULL COMMENT 'Отправить SMS?',
    `sms_template`     text         DEFAULT NULL COMMENT 'Шаблон SMS сообщения',
    ...
    `task_description` text         DEFAULT NULL COMMENT 'Описание задачи',
...
/*!40000 ALTER TABLE `pipeline`
    DISABLE KEYS */;
INSERT INTO `pipeline`
VALUES (1, 'Неразобранное',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #15bf63\">Неразобранное</span>',
        '#15bf63', 1,
        '<p>Здравствуйте {contact}!<br>Спасибо за обращение в нашу компанию! Ответственным менеджером по вашему обращению назначен&nbsp;{manager}.</p>',
        0,
        'Здравствуйте {contact}! Спасибо за обращение в нашу компанию! Ответственным менеджером по вашему обращению назначен {manager}.',
        0, '0000-00-00 00:00:00', '', 0, 0, 1),
       (2, 'Первичный контакт',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #25cfcf\">Первичный контакт</span>',
        '#25cfcf', 0, '', 0, '', 0, '0000-00-00 00:00:00', '', 0, 0, 2),
       (3, 'Принимают решение',
        ...
        '#1b77e3', 0, '', 0, '', 0, '0000-00-00 00:00:00', '', 0, 0, 3),
       (5, 'Завершена успешно',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #f78702\">Завершена успешно</span>',
        '#f78702', 0, '', 0, '', 0, '0000-00-00 00:00:00', '', 1, 0, 5),
       (6, 'Завершена неуспешно',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #cc6666\">Завершена неуспешно</span>',
        '#cc6666', 0, '', 0, '', 0, '0000-00-00 00:00:00', '', 0, 1, 6);
/*!40000 ALTER TABLE `pipeline`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `problem_cats`
    DISABLE KEYS */;
INSERT INTO `problem_cats`
VALUES (1, 'Известные проблемы'),
       (2, 'Новые проблемы');
/*!40000 ALTER TABLE `problem_cats`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `problem_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `problem_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `psreport`
    DISABLE KEYS */;
INSERT INTO `psreport`
VALUES (56, '13.03.2018 11:51', NULL, 'Электронная почта', 1, 0, 0, '00:00', '100', '90', NULL, 'NULL'),
       (57, '13.03.2018 11:51', NULL, 'Обслуживание сторонних клиентов', 0, 0, 0, '00:00', '100', '50', NULL, 'NULL'),
       (58, '13.03.2018 11:51', NULL, 'Обслуживание внутренних клиентов', 0, 0, 0, '00:00', '100', '90', NULL, 'NULL');
/*!40000 ALTER TABLE `psreport`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `pstatus`
    DISABLE KEYS */;
INSERT INTO `pstatus`
VALUES (1, 'Зарегистрирована',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Зарегистрирована</span>'),
       (2, 'Обходное решение',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #5692bb; vertical-align: baseline; white-space: nowrap; border: 1px solid #5692bb; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Обходное решение</span>'),
       (3, 'Решена',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #58595b; vertical-align: baseline; white-space: nowrap; border: 1px solid #58595b; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Решена</span>');
/*!40000 ALTER TABLE `pstatus`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `pureport`
    DISABLE KEYS */;
INSERT INTO `pureport`
VALUES (2, '02.04.2019 12:12', 'Рабочее место Кузнецова', 'Рабочая станция', 'Используется',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.84', 0, 0, 0);
/*!40000 ALTER TABLE `pureport`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `reply_templates`
    DISABLE KEYS */;
INSERT INTO `reply_templates`
VALUES (1, 'Недостаточно информации для выполнения заявки',
...
(
    ...
    `msbot_params`              text                DEFAULT NULL,
...
/*!40000 ALTER TABLE `request_escalates`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `request_escalates`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `request_fields`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `request_fields`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `request_files`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `request_files`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `roles`
    DISABLE KEYS */;
INSERT INTO `roles`
VALUES (1, 'Администратор', 'vsdeskadmin'),
       (2, 'Пользователь', 'vsdeskuser'),
       (3, 'Исполнитель', 'vsdeskmanager');
/*!40000 ALTER TABLE `roles`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `roles_rights`
    DISABLE KEYS */;
INSERT INTO `roles_rights`
VALUES (1, 1, 'Администратор', 'systemUser', 'Системная роль Пользователь', 0, 'Системная роль'),
       ...
       (14, 1, 'Администратор', 'updateDatesRequest', 'Пользователь может редактировать сроки дедлайнов заявок', 1,
        'Заявка'),
       (15, 1, 'Администратор', 'canAssignRequest', 'Исполнитель может назначать заявку другому исполнителю', 1,
        'Заявка'),
       ...
       (18, 1, 'Администратор', 'canSetObserversRequest', 'Пользователь может выбирать наблюдателей в форме заявки', 1,
        'Заявка'),
       (19, 1, 'Администратор', 'canSetFieldsRequest', 'Пользователь может заполнять наборы полей в форме заявки', 1,
        'Заявка'),
       (20, 1, 'Администратор', 'createProblem', 'Создавать проблемы', 0, 'Проблема'),
       (21, 1, 'Администратор', 'viewProblem', 'Просмотр проблем', 0, 'Проблема'),
       (22, 1, 'Администратор', 'listProblem', 'Отображать список проблем', 0, 'Проблема'),
       (23, 1, 'Администратор', 'updateProblem', 'Редактировать проблемы', 0, 'Проблема'),
       (24, 1, 'Администратор', 'deleteProblem', 'Удалять проблемы', 0, 'Проблема'),
       (25, 1, 'Администратор', 'canAssignProblem', 'Исполнитель может назначать проблему другому исполнителю', 0,
        'Проблема'),
       (26, 1, 'Администратор', 'uploadFilesProblem', 'Пользователь может прикреплять файлы к проблеме', 0, 'Проблема'),
       (27, 1, 'Администратор', 'batchUpdateProblem', 'Массовое закрытие проблем', 0, 'Проблема'),
       (28, 1, 'Администратор', 'batchDeleteProblem', 'Массовое удаление проблем', 0, 'Проблема'),
       (29, 1, 'Администратор', 'viewHistoryProblem', 'Пользователь может видеть историю проблемы', 0, 'Проблема'),
       ...
       (68, 1, 'Администратор', 'uploadFilesKB', 'Пользователь может прикреплять файлы к записи Базы знаний', 1,
        'База знаний'),
       ...
       (128, 1, 'Администратор', 'unitProblemReport', 'Доступ к отчету Проблемы по КЕ', 0, 'Отчеты'),
       (129, 1, 'Администратор', 'monthServiceProblemReport', 'Доступ к отчету Проблемы по сервисам за месяц', 0,
        'Отчеты'),
       ...
       (146, 1, 'Администратор', 'showlastNews', 'Отображать список последних новостей на главной панели', 1,
        'Интерфейс'),
       (147, 1, 'Администратор', 'showlastKB', 'Отображать список последних записей Базы знаний на главной панели', 1,
        'Интерфейс'),
       ...
       (157, 2, 'Пользователь', 'batchUpdateRequest', 'Массовое закрытие заявок', 1, 'Заявка'),
       ...
       (162, 2, 'Пользователь', 'updateDatesRequest', 'Пользователь может редактировать сроки дедлайнов заявок', 0,
        'Заявка'),
       (163, 2, 'Пользователь', 'canAssignRequest', 'Исполнитель может назначать заявку другому исполнителю', 0,
        'Заявка'),
       ...
       (166, 2, 'Пользователь', 'canSetObserversRequest', 'Пользователь может выбирать наблюдателей в форме заявки', 1,
        'Заявка'),
       (167, 2, 'Пользователь', 'canSetFieldsRequest', 'Пользователь может заполнять наборы полей в форме заявки', 1,
        'Заявка'),
       ...
       (173, 2, 'Пользователь', 'canAssignProblem', 'Исполнитель может назначать проблему другому исполнителю', 0,
        'Проблема'),
       ...
       (216, 2, 'Пользователь', 'uploadFilesKB', 'Пользователь может прикреплять файлы к записи Базы знаний', 0,
        'База знаний'),
       ...
       (277, 2, 'Пользователь', 'monthServiceProblemReport', 'Доступ к отчету Проблемы по сервисам за месяц', 0,
        'Отчеты'),
       ...
       (294, 2, 'Пользователь', 'showlastNews', 'Отображать список последних новостей на главной панели', 1,
        'Интерфейс'),
       (295, 2, 'Пользователь', 'showlastKB', 'Отображать список последних записей Базы знаний на главной панели', 1,
        'Интерфейс'),
       ...
       (310, 3, 'Исполнитель', 'updateDatesRequest', 'Пользователь может редактировать сроки дедлайнов заявок', 0,
        'Заявка'),
       (311, 3, 'Исполнитель', 'canAssignRequest', 'Исполнитель может назначать заявку другому исполнителю', 1,
        'Заявка'),
       ...
       (314, 3, 'Исполнитель', 'canSetObserversRequest', 'Пользователь может выбирать наблюдателей в форме заявки', 1,
        'Заявка'),
       (315, 3, 'Исполнитель', 'canSetFieldsRequest', 'Пользователь может заполнять наборы полей в форме заявки', 1,
        'Заявка'),
       ...
       (321, 3, 'Исполнитель', 'canAssignProblem', 'Исполнитель может назначать проблему другому исполнителю', 0,
        'Проблема'),
       ...
       (364, 3, 'Исполнитель', 'uploadFilesKB', 'Пользователь может прикреплять файлы к записи Базы знаний', 1,
        'База знаний'),
       ...
       (425, 3, 'Исполнитель', 'monthServiceProblemReport', 'Доступ к отчету Проблемы по сервисам за месяц', 0,
        'Отчеты'),
       ...
       (442, 3, 'Исполнитель', 'showlastNews', 'Отображать список последних новостей на главной панели', 1,
        'Интерфейс'),
       (443, 3, 'Исполнитель', 'showlastKB', 'Отображать список последних записей Базы знаний на главной панели', 1,
        'Интерфейс'),
       ...
       (451, 1, 'Администратор', 'monthServiceRequestsReport', 'Доступ к отчету Заявки по сервисам за месяц', 1,
        'Отчеты'),
       (452, 2, 'Пользователь', 'monthServiceRequestsReport', 'Доступ к отчету Заявки по сервисам за месяц', 0,
        'Отчеты'),
       (453, 3, 'Исполнитель', 'monthServiceRequestsReport', 'Доступ к отчету Заявки по сервисам за месяц', 0,
        'Отчеты'),
       ...
       (457, 1, 'Администратор', 'mainGraphAllGroupsManagers', 'Отображать график по группам исполнитилей', 0,
        'Графики'),
       (458, 1, 'Администратор', 'viewMyCompanyRequest', 'Пользователь видит все заявки своей компании', 0, 'Заявка'),
       (459, 1, 'Администратор', 'canViewFieldsRequest', 'Пользователь видит наборы полей в окне просмотра заявки', 1,
        'Заявка'),
       ...
       (471, 1, 'Администратор', 'mainGraphCompanyCurentUserStatus', 'График заявок по компании текущего пользователя',
        0, 'Графики'),
       (472, 2, 'Пользователь', 'viewMyCompanyRequest', 'Пользователь видит все заявки своей компании', 0, 'Заявка'),
       (473, 2, 'Пользователь', 'canViewFieldsRequest', 'Пользователь видит наборы полей в окне просмотра заявки', 0,
        'Заявка'),
       ...
       (485, 2, 'Пользователь', 'mainGraphCompanyCurentUserStatus', 'График заявок по компании текущего пользователя',
        0, 'Графики'),
       (486, 3, 'Исполнитель', 'viewMyCompanyRequest', 'Пользователь видит все заявки своей компании', 0, 'Заявка'),
       (487, 3, 'Исполнитель', 'canViewFieldsRequest', 'Пользователь видит наборы полей в окне просмотра заявки', 1,
        'Заявка'),
       ...
       (499, 3, 'Исполнитель', 'mainGraphCompanyCurentUserStatus', 'График заявок по компании текущего пользователя', 0,
        'Графики'),
       (500, 1, 'Администратор', 'createUnitTemplates', 'Создавать шаблоны печатной формы', 1, 'Шаблоны печатных форм'),
       (501, 1, 'Администратор', 'listUnitTemplates', 'Просматривать список шаблонов печтаных форм', 1,
        'Шаблоны печатных форм'),
       (502, 1, 'Администратор', 'updateUnitTemplates', 'Редактировать шаблоны печатных форм', 1,
        'Шаблоны печатных форм'),
       ...
       (505, 2, 'Пользователь', 'listUnitTemplates', 'Просматривать список шаблонов печтаных форм', 0,
        'Шаблоны печатных форм'),
       (506, 2, 'Пользователь', 'updateUnitTemplates', 'Редактировать шаблоны печатных форм', 0,
        'Шаблоны печатных форм'),
       ...
       (509, 3, 'Исполнитель', 'listUnitTemplates', 'Просматривать список шаблонов печтаных форм', 0,
        'Шаблоны печатных форм'),
       (510, 3, 'Исполнитель', 'updateUnitTemplates', 'Редактировать шаблоны печатных форм', 0,
        'Шаблоны печатных форм'),
       ...
       (516, 3, 'Исполнитель', 'batchAssignRequest', 'Массовое переназначение исполнителей', 1, 'Заявка'),
       ...
       (526, 3, 'Исполнитель', 'viewAssignedRequest', 'Менеджер видит только назначенные ему заявки', 0, 'Заявка'),
       ...
       (530, 1, 'Администратор', 'listCronRequest', 'Отображать список запланированных заявок', 1, 'Заявка'),
       (531, 2, 'Пользователь', 'listCronRequest', 'Отображать список запланированных заявок', 0, 'Заявка'),
       (532, 3, 'Исполнитель', 'listCronRequest', 'Отображать список запланированных заявок', 0, 'Заявка'),
       (533, 1, 'Администратор', 'createAstatus', 'Создавать статусы активов и КЕ', 1, 'Статусы активов и КЕ'),
       (534, 1, 'Администратор', 'listAstatus', 'Отображать список статусов активов и КЕ', 1, 'Статусы активов и КЕ'),
       (535, 1, 'Администратор', 'updateAstatus', 'Редактировать статусы активов и КЕ', 1, 'Статусы активов и КЕ'),
       (536, 1, 'Администратор', 'deleteAstatus', 'Удалять статусы активов и КЕ', 1, 'Статусы активов и КЕ'),
       (537, 1, 'Администратор', 'canEditCommentsRequest', 'Пользователь может редактировать комментарии в заявке', 1,
        'Заявка'),
       (538, 2, 'Пользователь', 'createAstatus', 'Создавать статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (539, 2, 'Пользователь', 'listAstatus', 'Отображать список статусов активов и КЕ', 0, 'Статусы активов и КЕ'),
       (540, 2, 'Пользователь', 'updateAstatus', 'Редактировать статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (541, 2, 'Пользователь', 'deleteAstatus', 'Удалять статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (542, 2, 'Пользователь', 'canEditCommentsRequest', 'Пользователь может редактировать комментарии в заявке', 0,
        'Заявка'),
       (543, 3, 'Исполнитель', 'createAstatus', 'Создавать статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (544, 3, 'Исполнитель', 'listAstatus', 'Отображать список статусов активов и КЕ', 0, 'Статусы активов и КЕ'),
       (545, 3, 'Исполнитель', 'updateAstatus', 'Редактировать статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (546, 3, 'Исполнитель', 'deleteAstatus', 'Удалять статусы активов и КЕ', 0, 'Статусы активов и КЕ'),
       (547, 3, 'Исполнитель', 'canEditCommentsRequest', 'Пользователь может редактировать комментарии в заявке', 0,
        'Заявка'),
       (548, 1, 'Администратор', 'readChat', 'Доступ к посмотру чата', 0, 'Чат'),
       (549, 1, 'Администратор', 'adminChat', 'Администрирование чата', 0, 'Чат'),
       (550, 1, 'Администратор', 'viewMyAssignedRequest', 'Менеджер видит как назначенные ему, так и свои заявки', 0,
        'Заявка'),
       (551, 1, 'Администратор', 'unitByUserRequest', 'Отображать только принадлежащие пользователю КЕ', 0, 'Заявка'),
       (552, 1, 'Администратор', 'printRequest', 'Печать заявки', 1, 'Заявка'),
       (553, 1, 'Администратор', 'canSetPriority', 'Разрешить пользователю выбирать приоритет в полной форме заявки', 0,
        'Заявка'),
       (554, 1, 'Администратор', 'canEditContent', 'Пользователь может редактировать содержание в заявке', 1, 'Заявка'),
       (555, 1, 'Администратор', 'canAddTemplate', 'Пользователь может добавить шаблон ответа из комментария', 1,
        'Заявка'),
       (556, 1, 'Администратор', 'canAddKBreply', 'Пользователь может добавить в базу знаний ответ из комментария', 1,
        'Заявка'),
       (557, 1, 'Администратор', 'pushSettings', 'Push уведомления', 1, 'Настройки'),
       (558, 1, 'Администратор', 'amiSettings', 'Интеграция с Asterisk', 1, 'Настройки'),
       (559, 1, 'Администратор', 'allowSoundNotify', 'Разрешить звуковые уведомления', 1, 'Интерфейс'),
       (560, 1, 'Администратор', 'createAPI', 'Create APIs', 1, 'API'),
       (561, 1, 'Администратор', 'updateAPI', 'Update APIs', 1, 'API'),
       (562, 1, 'Администратор', 'viewAPI', 'View APIs', 1, 'API'),
       (563, 1, 'Администратор', 'listAPI', 'List APIs', 1, 'API'),
       (564, 1, 'Администратор', 'deleteAPI', 'Delete APIs', 1, 'API'),
       (565, 1, 'Администратор', 'viewCalls', 'Просматривать звонки', 1, 'Звонки'),
       (566, 1, 'Администратор', 'listCalls', 'Отображать список звонков', 1, 'Звонки'),
       (567, 1, 'Администратор', 'deleteCalls', 'Удалять звонки', 1, 'Звонки'),
       (568, 2, 'Пользователь', 'readChat', 'Доступ к посмотру чата', 0, 'Чат'),
       (569, 2, 'Пользователь', 'adminChat', 'Администрирование чата', 0, 'Чат'),
       (570, 2, 'Пользователь', 'viewMyAssignedRequest', 'Менеджер видит как назначенные ему, так и свои заявки', 0,
        'Заявка'),
       (571, 2, 'Пользователь', 'unitByUserRequest', 'Отображать только принадлежащие пользователю КЕ', 1, 'Заявка'),
       (572, 2, 'Пользователь', 'printRequest', 'Печать заявки', 0, 'Заявка'),
       (573, 2, 'Пользователь', 'canSetPriority', 'Разрешить пользователю выбирать приоритет в полной форме заявки', 1,
        'Заявка'),
       (574, 2, 'Пользователь', 'canEditContent', 'Пользователь может редактировать содержание в заявке', 0, 'Заявка'),
       (575, 2, 'Пользователь', 'canAddTemplate', 'Пользователь может добавить шаблон ответа из комментария', 0,
        'Заявка'),
       (576, 2, 'Пользователь', 'canAddKBreply', 'Пользователь может добавить в базу знаний ответ из комментария', 0,
        'Заявка'),
       (577, 2, 'Пользователь', 'pushSettings', 'Push уведомления', 0, 'Настройки'),
       (578, 2, 'Пользователь', 'amiSettings', 'Интеграция с Asterisk', 0, 'Настройки'),
       (579, 2, 'Пользователь', 'allowSoundNotify', 'Разрешить звуковые уведомления', 0, 'Интерфейс'),
       (580, 2, 'Пользователь', 'createAPI', 'Create APIs', 0, 'API'),
       (581, 2, 'Пользователь', 'updateAPI', 'Update APIs', 0, 'API'),
       (582, 2, 'Пользователь', 'viewAPI', 'View APIs', 0, 'API'),
       (583, 2, 'Пользователь', 'listAPI', 'List APIs', 0, 'API'),
       (584, 2, 'Пользователь', 'deleteAPI', 'Delete APIs', 0, 'API'),
       (585, 2, 'Пользователь', 'viewCalls', 'Просматривать звонки', 0, 'Звонки'),
       (586, 2, 'Пользователь', 'listCalls', 'Отображать список звонков', 0, 'Звонки'),
       (587, 2, 'Пользователь', 'deleteCalls', 'Удалять звонки', 0, 'Звонки'),
       (588, 3, 'Исполнитель', 'readChat', 'Доступ к посмотру чата', 0, 'Чат'),
       (589, 3, 'Исполнитель', 'adminChat', 'Администрирование чата', 0, 'Чат'),
       (590, 3, 'Исполнитель', 'viewMyAssignedRequest', 'Менеджер видит как назначенные ему, так и свои заявки', 1,
        'Заявка'),
       (591, 3, 'Исполнитель', 'unitByUserRequest', 'Отображать только принадлежащие пользователю КЕ', 0, 'Заявка'),
       (592, 3, 'Исполнитель', 'printRequest', 'Печать заявки', 0, 'Заявка'),
       (593, 3, 'Исполнитель', 'canSetPriority', 'Разрешить пользователю выбирать приоритет в полной форме заявки', 0,
        'Заявка'),
       (594, 3, 'Исполнитель', 'canEditContent', 'Пользователь может редактировать содержание в заявке', 0, 'Заявка'),
       (595, 3, 'Исполнитель', 'canAddTemplate', 'Пользователь может добавить шаблон ответа из комментария', 0,
        'Заявка'),
       (596, 3, 'Исполнитель', 'canAddKBreply', 'Пользователь может добавить в базу знаний ответ из комментария', 0,
        'Заявка'),
       (597, 3, 'Исполнитель', 'pushSettings', 'Push уведомления', 0, 'Настройки'),
       (598, 3, 'Исполнитель', 'amiSettings', 'Интеграция с Asterisk', 0, 'Настройки'),
       (599, 3, 'Исполнитель', 'allowSoundNotify', 'Разрешить звуковые уведомления', 0, 'Интерфейс'),
       (600, 3, 'Исполнитель', 'createAPI', 'Create APIs', 0, 'API'),
       (601, 3, 'Исполнитель', 'updateAPI', 'Update APIs', 0, 'API'),
       (602, 3, 'Исполнитель', 'viewAPI', 'View APIs', 0, 'API'),
       (603, 3, 'Исполнитель', 'listAPI', 'List APIs', 0, 'API'),
       (604, 3, 'Исполнитель', 'deleteAPI', 'Delete APIs', 0, 'API'),
       (605, 3, 'Исполнитель', 'viewCalls', 'Просматривать звонки', 0, 'Звонки'),
       (606, 3, 'Исполнитель', 'listCalls', 'Отображать список звонков', 0, 'Звонки'),
       (607, 3, 'Исполнитель', 'deleteCalls', 'Удалять звонки', 0, 'Звонки'),
       (609, 1, 'Администратор', 'prevnextRequest', 'Пользователь видит виджет перелистывания заявок в окне просмотра',
        0, 'Заявка'),
       ...
       (613, 2, 'Пользователь', 'prevnextRequest', 'Пользователь видит виджет перелистывания заявок в окне просмотра',
        0, 'Заявка'),
       ...
       (617, 3, 'Исполнитель', 'prevnextRequest', 'Пользователь видит виджет перелистывания заявок в окне просмотра', 0,
        'Заявка'),
       ...
       (623, 1, 'Администратор', 'updateLeadRequest',
        'Пользователь может редактировать затраченное время на выполнение заявки', 1, 'Заявка'),
       (624, 2, 'Пользователь', 'updateLeadRequest',
        'Пользователь может редактировать затраченное время на выполнение заявки', 0, 'Заявка'),
       (625, 3, 'Исполнитель', 'updateLeadRequest',
        'Пользователь может редактировать затраченное время на выполнение заявки', 0, 'Заявка'),
       (626, 1, 'Администратор', 'widgetSettings', 'Виджет на сайт', 1, 'Настройки'),
       (627, 2, 'Пользователь', 'widgetSettings', 'Виджет на сайт', 0, 'Настройки'),
       (628, 3, 'Исполнитель', 'widgetSettings', 'Виджет на сайт', 0, 'Настройки'),
       ...
       (632, 1, 'Администратор', 'downfieldsRequest', 'Отображать дополнительные поля под содержанием', 1, 'Заявка'),
       (633, 2, 'Пользователь', 'downfieldsRequest', 'Отображать дополнительные поля под содержанием', 1, 'Заявка'),
       (634, 3, 'Исполнитель', 'downfieldsRequest', 'Отображать дополнительные поля под содержанием', 1, 'Заявка'),
       (635, 1, 'Администратор', 'canViewFieldsRequestList', 'Пользователь видит доп. поля в списке заявок', 1,
        'Заявка'),
       (636, 1, 'Администратор', 'deleteUnitTemplates', 'Удалять шаблоны печатных форм', 0, 'Шаблоны печатных форм'),
       (637, 1, 'Администратор', 'listSelects', 'Отображать списки', 1, 'Списки'),
       (638, 1, 'Администратор', 'createSelects', 'Создавать списки', 1, 'Списки'),
       (639, 1, 'Администратор', 'updateSelects', 'Редактировать списки', 1, 'Списки'),
       (640, 1, 'Администратор', 'deleteSelects', 'Удалять списки', 1, 'Списки'),
       (641, 2, 'Пользователь', 'canViewFieldsRequestList', 'Пользователь видит доп. поля в списке заявок', 0,
        'Заявка'),
       (642, 2, 'Пользователь', 'deleteUnitTemplates', 'Удалять шаблоны печатных форм', 0, 'Шаблоны печатных форм'),
       (643, 2, 'Пользователь', 'listSelects', 'Отображать списки', 0, 'Списки'),
       (644, 2, 'Пользователь', 'createSelects', 'Создавать списки', 0, 'Списки'),
       (645, 2, 'Пользователь', 'updateSelects', 'Редактировать списки', 0, 'Списки'),
       (646, 2, 'Пользователь', 'deleteSelects', 'Удалять списки', 0, 'Списки'),
       (647, 3, 'Исполнитель', 'canViewFieldsRequestList', 'Пользователь видит доп. поля в списке заявок', 1, 'Заявка'),
       (648, 3, 'Исполнитель', 'deleteUnitTemplates', 'Удалять шаблоны печатных форм', 0, 'Шаблоны печатных форм'),
       (649, 3, 'Исполнитель', 'listSelects', 'Отображать списки', 0, 'Списки'),
       (650, 3, 'Исполнитель', 'createSelects', 'Создавать списки', 0, 'Списки'),
       (651, 3, 'Исполнитель', 'updateSelects', 'Редактировать списки', 0, 'Списки'),
       (652, 3, 'Исполнитель', 'deleteSelects', 'Удалять списки', 0, 'Списки'),
       (653, 1, 'Администратор', 'fieldsCompany', 'Управлять полями компании', 1, 'Компания'),
       (654, 2, 'Пользователь', 'fieldsCompany', 'Управлять полями компании', 0, 'Компания'),
       (655, 3, 'Исполнитель', 'fieldsCompany', 'Управлять полями компании', 0, 'Компания'),
       (656, 1, 'Администратор', 'vbotSettings', 'Интеграция c Viber ботом', 1, 'Настройки'),
       ...
       (659, 1, 'Администратор', 'canStartTWSession', 'Пользователь может инициализировать сессию Team Viewer', 1,
        'Заявка'),
       (660, 1, 'Администратор', 'batchDeleteAsset', 'Массовое удаление активов', 1, 'Актив'),
       (661, 1, 'Администратор', 'batchDeleteUnit', 'Массовое удаление КЕ', 1, 'КЕ'),
       (662, 1, 'Администратор', 'batchDeleteUser', 'Массовое удаление пользователей', 1, 'Пользователь'),
       (663, 1, 'Администратор', 'batchDeleteCompany', 'Массовое удаление компаний', 1, 'Компания'),
       (664, 1, 'Администратор', 'twSettings', 'Интеграция c TeamViewer', 1, 'Настройки'),
       (665, 2, 'Пользователь', 'canStartTWSession', 'Пользователь может инициализировать сессию Team Viewer', 0,
        'Заявка'),
       (666, 2, 'Пользователь', 'batchDeleteAsset', 'Массовое удаление активов', 0, 'Актив'),
       (667, 2, 'Пользователь', 'batchDeleteUnit', 'Массовое удаление КЕ', 0, 'КЕ'),
       (668, 2, 'Пользователь', 'batchDeleteUser', 'Массовое удаление пользователей', 0, 'Пользователь'),
       (669, 2, 'Пользователь', 'batchDeleteCompany', 'Массовое удаление компаний', 0, 'Компания'),
       (670, 2, 'Пользователь', 'twSettings', 'Интеграция c TeamViewer', 0, 'Настройки'),
       (671, 3, 'Исполнитель', 'canStartTWSession', 'Пользователь может инициализировать сессию Team Viewer', 1,
        'Заявка'),
       (672, 3, 'Исполнитель', 'batchDeleteAsset', 'Массовое удаление активов', 0, 'Актив'),
       (673, 3, 'Исполнитель', 'batchDeleteUnit', 'Массовое удаление КЕ', 0, 'КЕ'),
       (674, 3, 'Исполнитель', 'batchDeleteUser', 'Массовое удаление пользователей', 0, 'Пользователь'),
       (675, 3, 'Исполнитель', 'batchDeleteCompany', 'Массовое удаление компаний', 0, 'Компания'),
       (676, 3, 'Исполнитель', 'twSettings', 'Интеграция c TeamViewer', 0, 'Настройки'),
       ...
       (680, 1, 'Администратор', 'viewPhonebook', 'Просмотр пользователей телефонной книги', 1, 'Телефонная книга'),
       (681, 1, 'Администратор', 'listPhonebook', 'Просмотр телефонной книги', 1, 'Телефонная книга'),
       (682, 2, 'Пользователь', 'viewPhonebook', 'Просмотр пользователей телефонной книги', 1, 'Телефонная книга'),
       (683, 2, 'Пользователь', 'listPhonebook', 'Просмотр телефонной книги', 1, 'Телефонная книга'),
       (684, 3, 'Исполнитель', 'viewPhonebook', 'Просмотр пользователей телефонной книги', 1, 'Телефонная книга'),
       (685, 3, 'Исполнитель', 'listPhonebook', 'Просмотр телефонной книги', 1, 'Телефонная книга'),
       (686, 1, 'Администратор', 'viewGroupRequest', 'Исполнитель может видеть завершенные заявки членов своей группы',
        0, 'Заявка'),
       (687, 2, 'Пользователь', 'viewGroupRequest', 'Исполнитель может видеть завершенные заявки членов своей группы',
        0, 'Заявка'),
       (688, 3, 'Исполнитель', 'viewGroupRequest', 'Исполнитель может видеть завершенные заявки членов своей группы', 0,
        'Заявка'),
       (689, 1, 'Администратор', 'jiraSettings', 'Интеграция с Jira', 1, 'Настройки'),
       (690, 1, 'Администратор', 'showTicketCalendar', 'Отображать календарь заявок на главной панели', 1, 'Интерфейс'),
       (691, 2, 'Пользователь', 'jiraSettings', 'Интеграция с Jira', 0, 'Настройки'),
       (692, 2, 'Пользователь', 'showTicketCalendar', 'Отображать календарь заявок на главной панели', 0, 'Интерфейс'),
       (693, 3, 'Исполнитель', 'jiraSettings', 'Интеграция с Jira', 0, 'Настройки'),
       (694, 3, 'Исполнитель', 'showTicketCalendar', 'Отображать календарь заявок на главной панели', 0, 'Интерфейс'),
       (695, 1, 'Администратор', 'viewAllGroupRequest', 'Исполнитель может видеть все заявки членов своей группы', 0,
        'Заявка'),
       (696, 1, 'Администратор', 'canSuspendRequest', 'Пользователь может поставть заявку на паузу', 1, 'Заявка'),
       (697, 1, 'Администратор', 'uploadFilesAsset', 'Пользователь может прикреплять файлы к активу', 1, 'Актив'),
       (698, 1, 'Администратор', 'uploadFilesUnit', 'Пользователь может прикреплять файлы к КЕ', 1, 'КЕ'),
       (699, 1, 'Администратор', 'uploadFilesCompany', 'Пользователь может прикреплять файлы к компании', 1,
        'Компания'),
       (700, 2, 'Пользователь', 'viewAllGroupRequest', 'Исполнитель может видеть все заявки членов своей группы', 0,
        'Заявка'),
       (701, 2, 'Пользователь', 'canSuspendRequest', 'Пользователь может поставть заявку на паузу', 0, 'Заявка'),
       (702, 2, 'Пользователь', 'uploadFilesAsset', 'Пользователь может прикреплять файлы к активу', 0, 'Актив'),
       (703, 2, 'Пользователь', 'uploadFilesUnit', 'Пользователь может прикреплять файлы к КЕ', 0, 'КЕ'),
       (704, 2, 'Пользователь', 'uploadFilesCompany', 'Пользователь может прикреплять файлы к компании', 0, 'Компания'),
       (705, 3, 'Исполнитель', 'viewAllGroupRequest', 'Исполнитель может видеть все заявки членов своей группы', 0,
        'Заявка'),
       (706, 3, 'Исполнитель', 'canSuspendRequest', 'Пользователь может поставть заявку на паузу', 1, 'Заявка'),
       (707, 3, 'Исполнитель', 'uploadFilesAsset', 'Пользователь может прикреплять файлы к активу', 0, 'Актив'),
       (708, 3, 'Исполнитель', 'uploadFilesUnit', 'Пользователь может прикреплять файлы к КЕ', 0, 'КЕ'),
       (709, 3, 'Исполнитель', 'uploadFilesCompany', 'Пользователь может прикреплять файлы к компании', 0, 'Компания'),
       (710, 1, 'Администратор', 'portalSettings', 'Настройки портала самообслуживания', 1, 'Настройки'),
       (711, 2, 'Пользователь', 'portalSettings', 'Настройки портала самообслуживания', 0, 'Настройки'),
       (712, 3, 'Исполнитель', 'portalSettings', 'Настройки портала самообслуживания', 0, 'Настройки'),
       (722, 1, 'Администратор', 'msbotSettings', 'Интеграция с Microsoft bot framework', 1, 'Настройки'),
       (729, 2, 'Пользователь', 'msbotSettings', 'Интеграция с Microsoft bot framework', 0, 'Настройки'),
       (736, 3, 'Исполнитель', 'msbotSettings', 'Интеграция с Microsoft bot framework', 0, 'Настройки'),
       ...
       (741, 1, 'Администратор', 'deleteContracts', 'Удалять договоры', 1, 'Договоры'),
       (742, 1, 'Администратор', 'uploadFilesContracts', 'Пользователь может прикреплять файлы к договорам', 1,
        'Договоры'),
       (743, 2, 'Пользователь', 'createContracts', 'Создавать договоры', 0, 'Договоры'),
       (744, 2, 'Пользователь', 'viewContracts', 'Просматривать договоры', 0, 'Договоры'),
       ...
       (748, 2, 'Пользователь', 'uploadFilesContracts', 'Пользователь может прикреплять файлы к договорам', 0,
        'Договоры'),
       ...
       (754, 3, 'Исполнитель', 'uploadFilesContracts', 'Пользователь может прикреплять файлы к договорам', 0,
        'Договоры'),
       (755, 1, 'Администратор', 'printContracts', 'Печать договоров', 1, 'Договоры'),
       (756, 2, 'Пользователь', 'printContracts', 'Печать договоров', 0, 'Договоры'),
       (757, 3, 'Исполнитель', 'printContracts', 'Печать договоров', 0, 'Договоры'),
       (761, 1, 'Администратор', 'managersKPIReport', 'Отчет по KPI', 1, 'Отчеты'),
       (762, 2, 'Пользователь', 'managersKPIReport', 'Отчет по KPI', 0, 'Отчеты'),
       (763, 3, 'Исполнитель', 'managersKPIReport', 'Отчет по KPI', 0, 'Отчеты'),
       (764, 1, 'Администратор', 'readChat', 'Доступ к просмотру чата', 0, 'Чат'),
       (765, 1, 'Администратор', 'canDeleteCommentsRequest', 'Пользователь может удалять комментарии в заявке', 1,
        'Заявка'),
       (766, 1, 'Администратор', 'canAddCommentsRequest', 'Пользователь может добавлять комментарии', 1, 'Заявка'),
       (767, 1, 'Администратор', 'viewMyDepartRequest',
        'Пользователь может видеть все заявки Подразделений, где он руководитель', 0, 'Заявка'),
       (768, 1, 'Администратор', 'canSuspendRequest', 'Пользователь может поставить заявку на паузу', 1, 'Заявка'),
       (769, 1, 'Администратор', 'canChangeUser', 'Исполнитель может изменить заказчика в заявке', 1, 'Заявка'),
       (770, 1, 'Администратор', 'canSelectDeadline', 'Пользователь может выбрать дедлайн и исполнителя в форме заявки',
        0, 'Заявка'),
       (771, 1, 'Администратор', 'viewOnlyUserCompanyPhonebook',
        'Отображать только контакты компании пользователя в телефонной книге', 0, 'Телефонная книга'),
       (772, 1, 'Администратор', 'listUnitTemplates', 'Просматривать список шаблонов печатных форм', 0,
        'Шаблоны печатных форм'),
       (773, 2, 'Пользователь', 'readChat', 'Доступ к просмотру чата', 0, 'Чат'),
       (774, 2, 'Пользователь', 'canDeleteCommentsRequest', 'Пользователь может удалять комментарии в заявке', 0,
        'Заявка'),
       (775, 2, 'Пользователь', 'canAddCommentsRequest', 'Пользователь может добавлять комментарии', 1, 'Заявка'),
       (776, 2, 'Пользователь', 'viewMyDepartRequest',
        'Пользователь может видеть все заявки Подразделений, где он руководитель', 0, 'Заявка'),
       ...
       (779, 2, 'Пользователь', 'canSelectDeadline', 'Пользователь может выбрать дедлайн и исполнителя в форме заявки',
        0, 'Заявка'),
       (780, 2, 'Пользователь', 'viewOnlyUserCompanyPhonebook',
        'Отображать только контакты компании пользователя в телефонной книге', 0, 'Телефонная книга'),
       (781, 2, 'Пользователь', 'listUnitTemplates', 'Просматривать список шаблонов печатных форм', 0,
        'Шаблоны печатных форм'),
       (782, 3, 'Исполнитель', 'readChat', 'Доступ к просмотру чата', 0, 'Чат'),
       (783, 3, 'Исполнитель', 'canDeleteCommentsRequest', 'Пользователь может удалять комментарии в заявке', 0,
        'Заявка'),
       (784, 3, 'Исполнитель', 'canAddCommentsRequest', 'Пользователь может добавлять комментарии', 1, 'Заявка'),
       (785, 3, 'Исполнитель', 'viewMyDepartRequest',
        'Пользователь может видеть все заявки Подразделений, где он руководитель', 0, 'Заявка'),
       ...
       (788, 3, 'Исполнитель', 'canSelectDeadline', 'Пользователь может выбрать дедлайн и исполнителя в форме заявки',
        0, 'Заявка'),
       (789, 3, 'Исполнитель', 'viewOnlyUserCompanyPhonebook',
        'Отображать только контакты компании пользователя в телефонной книге', 0, 'Телефонная книга'),
       (790, 3, 'Исполнитель', 'listUnitTemplates', 'Просматривать список шаблонов печатных форм', 0,
        'Шаблоны печатных форм'),
       (791, 1, 'Администратор', 'cantSelectCustomer',
        'Исполнитель не может выбирать заказчика в форме создания заявки', 0, 'Заявка'),
       (792, 2, 'Пользователь', 'cantSelectCustomer', 'Исполнитель не может выбирать заказчика в форме создания заявки',
        0, 'Заявка'),
       (793, 3, 'Исполнитель', 'cantSelectCustomer', 'Исполнитель не может выбирать заказчика в форме создания заявки',
        0, 'Заявка'),
       (794, 1, 'Администратор', 'doNotSelectServiceCategories', 'Не использовать выбор категории сервиса', 1,
        'Заявка'),
       (812, 1, 'Администратор', 'createServiceCategory', 'Создавать категории сервисов', 1, 'Категория сервиса'),
       (813, 1, 'Администратор', 'viewServiceCategory', 'Просматривать категории сервисов', 1, 'Категория сервиса'),
       (814, 1, 'Администратор', 'listServiceCategory', 'Отображать список категорий сервисов', 1, 'Категория сервиса'),
       (815, 1, 'Администратор', 'updateServiceCategory', 'Редактировать категории сервисов', 1, 'Категория сервиса'),
       (816, 1, 'Администратор', 'deleteServiceCategory', 'Удалять категории сервисов', 1, 'Категория сервиса'),
       (817, 2, 'Пользователь', 'doNotSelectServiceCategories', 'Не использовать выбор категории сервиса', 1, 'Заявка'),
       (818, 2, 'Пользователь', 'createServiceCategory', 'Создавать категории сервисов', 0, 'Категория сервиса'),
       (819, 2, 'Пользователь', 'viewServiceCategory', 'Просматривать категории сервисов', 0, 'Категория сервиса'),
       (820, 2, 'Пользователь', 'listServiceCategory', 'Отображать список категорий сервисов', 0, 'Категория сервиса'),
       (821, 2, 'Пользователь', 'updateServiceCategory', 'Редактировать категории сервисов', 0, 'Категория сервиса'),
       (822, 2, 'Пользователь', 'deleteServiceCategory', 'Удалять категории сервисов', 0, 'Категория сервиса'),
       (823, 3, 'Исполнитель', 'doNotSelectServiceCategories', 'Не использовать выбор категории сервиса', 1, 'Заявка'),
       (824, 3, 'Исполнитель', 'createServiceCategory', 'Создавать категории сервисов', 0, 'Категория сервиса'),
       (825, 3, 'Исполнитель', 'viewServiceCategory', 'Просматривать категории сервисов', 0, 'Категория сервиса'),
       (826, 3, 'Исполнитель', 'listServiceCategory', 'Отображать список категорий сервисов', 0, 'Категория сервиса'),
       (827, 3, 'Исполнитель', 'updateServiceCategory', 'Редактировать категории сервисов', 0, 'Категория сервиса'),
       (828, 3, 'Исполнитель', 'deleteServiceCategory', 'Удалять категории сервисов', 0, 'Категория сервиса'),
       (829, 1, 'Администратор', 'allowAlertNotify',
        'Использовать всплывающие уведомления (Снижает производительность)', 0, 'Интерфейс'),
       (830, 2, 'Пользователь', 'allowAlertNotify', 'Использовать всплывающие уведомления (Снижает производительность)',
        0, 'Интерфейс'),
       (831, 3, 'Исполнитель', 'allowAlertNotify', 'Использовать всплывающие уведомления (Снижает производительность)',
        0, 'Интерфейс');
/*!40000 ALTER TABLE `roles_rights`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `service`
    DISABLE KEYS */;
INSERT INTO `service`
VALUES (1, 'Электронная почта', 'Управление электронной почтой, создание и удаление почтовых ящиков.', '8x5 Basic',
        'Низкий', NULL, NULL, 90, 'Первая линия поддержки', '2', 2,
        '<p>\r\n         Прошу создать ящик электронной почты в домене @vsdesk.ru\r\n</p>', NULL, '', 1, 1, 0),
       (2, 'Обслуживание сторонних клиентов', 'Выездное обслуживание клиентов', '8x5 Basic', 'Низкий', NULL, NULL, 50,
        'Первая линия поддержки', '2', NULL, '', NULL, '', 1, 2, 0),
       (3, 'Обслуживание внутренних клиентов', 'Обслуживание внутренних пользователей компании', '8x5 Basic', 'Низкий',
        NULL, NULL, 90, 'Первая линия поддержки', '2', NULL, '', NULL, '', 1, 2, 0);
/*!40000 ALTER TABLE `service`
    ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client = @@character_set_client */;
...
/*!50003 SET sql_mode = 'NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `service_request_update`
    AFTER UPDATE
    ON `service`
    FOR EACH ROW
    IF (old.`name` <> new.`name`) THEN
...
/*!40000 ALTER TABLE `service_categories`
    DISABLE KEYS */;
INSERT INTO `service_categories`
VALUES (2, 'Внешний отдел'),
       (1, 'Внутренний отдел');
/*!40000 ALTER TABLE `service_categories`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `sla`
    DISABLE KEYS */;
INSERT INTO `sla`
VALUES (1, '8x5 Basic', '01', '00', '02', '00', '01:00', '02:00',
        '01.01.*,02.01.*,03.01.*,04.01.*,05.01.*,06.01.*,07.01.*,08.01.*,23.02.*,08.03.*,01.05.*,02.05.*,03.05.*,09.05.*,10.05.*,12.06.*,04.11.*',
        '90', '08:00', '18:00', 0, 0, '00', '10', '00', '10', '00:10', '00:10', 0, 10),
       (2, '8x5 Optimal', '08', '00', '24', '00', '08:00', '24:00',
        '01.01.*,02.01.*,03.01.*,04.01.*,05.01.*,06.01.*,07.01.*,08.01.*,23.02.*,08.03.*,01.05.*,02.05.*,03.05.*,09.05.*,10.05.*,12.06.*,04.11.*',
        '92', '09:00', '17:00', 0, 0, '00', '00', '00', '00', '00:00', '00:00', 0, 1),
       (3, '8x7 VIP', '00', '30', '01', '30', '00:30', '01:30',
        '01.01.*,02.01.*,03.01.*,04.01.*,05.01.*,06.01.*,07.01.*,08.01.*,23.02.*,08.03.*,01.05.*,02.05.*,03.05.*,09.05.*,10.05.*,12.06.*,04.11.*',
        '95', '08:00', '18:00', 0, 0, '00', '00', '00', '00', '00:00', '00:00', 0, 1);
/*!40000 ALTER TABLE `sla`
    ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client = @@character_set_client */;
...
/*!50003 SET sql_mode = 'NO_ENGINE_SUBSTITUTION' */;
DELIMITER ;;
/*!50003 CREATE */ /*50017 DEFINER =`root`@`%`*/ /*!50003 TRIGGER `sla_service_update`
    AFTER UPDATE
    ON `sla`
    FOR EACH ROW
    IF (old.`name` <> new.`name`) THEN
...
/*!40000 ALTER TABLE `sms`
    DISABLE KEYS */;
INSERT INTO `sms`
VALUES (1, 'default', '#{id} Изменен статус заявки {status}'),
       (2, 'SMS или боты заявка открыта',
        'Здравствуйте, {fullname}!\nВы успешно зарегистрировали заявку №{id}.\nЗаявке назначен исполнитель: {manager_name}\nТелефон исполнителя: {manager_phone}'),
       (3, 'SMS или боты заявка принята',
        '{fullname}, ваша заявка принята в исполнение {fStartTime}!\nИсполнитель: {manager_name}\nТелефон исполнителя: {manager_phone}\nEmail исполнителя: {manager_email}'),
       (4, 'SMS или боты заявка закрыта',
        'Уважаемый {fullname}, Ваша заявка была закрыта исполнителем {manager_name} {fEndTime}.\nОцените пожалуйста качество работ!');
/*!40000 ALTER TABLE `sms`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `sureport`
    DISABLE KEYS */;
INSERT INTO `sureport`
VALUES (124, 'Компания А', 'Рабочая станция', 1, '0'),
       (125, 'Компания А', 'Мобильное рабочее место', 0, '0'),
       (126, 'Компания А', 'Станция печати', 0, '0'),
       (127, 'Компания Б', 'Рабочая станция', 0, '0'),
       (128, 'Компания Б', 'Мобильное рабочее место', 0, '0'),
       (129, 'Компания Б', 'Станция печати', 0, '0');
/*!40000 ALTER TABLE `sureport`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `tbl_columns`
    DISABLE KEYS */;
INSERT INTO `tbl_columns`
VALUES ('assets-grid_1',
        'date||asset_attrib_name||name||cusers_fullname||cusers_dept||slabel||location||inventory||cost||Действия'),
       ('companies-grid_1', 'name||contact_name||phone||email||add1||ff_id_6||Действия'),
       ('companies-grid_2', 'name||director||email||contact_name||manager||Действия'),
       ('cunits-grid_1', 'date||type||name||slabel||company||fullname||dept||inventory||location||cost||Действия'),
       ('cusers-grid_1', 'photo||fullname||company||department||position||Email||Phone||role_name||Действия'),
       ...
       ('leads-grid_1',
        'status||name||created||creator||manager||company||contact||contact_phone||contact_email||contact_position||cost||Действия'),
       ('phonebook-grid_1', 'photo||fullname||city||department||Phone||intphone||mobile||position||Email'),
       ('phonebook-grid_2', 'photo||fullname||city||department||Phone||intphone||mobile||position||Email'),
       ('phonebook-grid_3', 'photo||fullname||city||department||Phone||intphone||mobile||position||Email'),
       ('problems-grid_1', 'slabel||date||creator||priority||category||manager||description||Действия'),
       ...
       ('request-grid-full-report_1',
        'channel||slabel||delays||delayedHours||Date||StartTime||fStartTime||EndTime||fEndTime||lead_time||Name||phone||room||Address||company||fullname||cunits||service_name||mfullname||groups_id||ZayavCategory_id||Priority||Content||rating'),
       ('request-grid-full2_1', 'channel||rating||slabel||Date||EndTime||Name||fullname||mfullname||Действия'),
       ('request-grid-full2_2',
        'channel||rating||slabel||Date||EndTime||Name||fullname||mfullname||ZayavCategory_id||Priority||Действия'),
       ('request-grid-full2_3',
        'rating||slabel||Date||EndTime||Name||fullname||mfullname||ZayavCategory_id||Priority||Действия'),
       ('request-grid-full_1',
        'rating||slabel||Date||EndTime||Name||fullname||mfullname||ZayavCategory_id||Priority||Действия'),
       ('request-grid-full_2',
        'slabel||Date||EndTime||Name||fullname||mfullname||ZayavCategory_id||Priority||Действия'),
       ('request-grid-full_3', 'channel||rating||slabel||Date||EndTime||Name||mfullname||Действия'),
       ('request-grid_1', 'slabel||Date||EndTime||Name||fullname||Действия'),
       ('request-grid_2', 'slabel||Date||EndTime||Name||fullname||mfullname||ZayavCategory_id||Priority||Действия'),
       ('request-grid_3', 'slabel||EndTime||Name||mfullname||Действия');
/*!40000 ALTER TABLE `tbl_columns`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `tbl_migration`
    DISABLE KEYS */;
INSERT INTO `tbl_migration`
VALUES ('m160621_080728_service_name_100', 1467292342),
       ...
       ('m170322_083228_40420', 1503911617),
       ('m170621_101254_40630', 1503911617),
       ('m170718_094135_40730', 1503911617),
       ('m170817_101337_40830', 1503911740),
       ('m170910_093205_41002', 1509710824),
       ('m171009_104738_41130', 1509710824),
       ('m171106_084110_41220', 1512738145),
       ('m180124_081753_180124', 1520064436),
       ('m180204_135747_50204', 1520064436),
       ('m180207_070507_50303', 1520064436),
       ('m180320_093226_50404', 1525334460),
       ('m180424_083445_50505', 1525334460),
       ('m180814_070219_50815', 1542004604),
       ('m181112_061452_51114', 1542004604),
       ('m190213_154051_60103', 1550075688),
       ('m190319_120022_60610', 1573111798),
       ('m191101_080141_70000', 1575011615),
       ('m191101_102240_70000_2', 1575011615);
/*!40000 ALTER TABLE `tbl_migration`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `teamviewer_sessions`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `teamviewer_sessions`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `uhistory`
    DISABLE KEYS */;
INSERT INTO `uhistory`
VALUES (80, 1, '27.12.2014 14:05', 'admin',
        'Добавлен актив: <b>Системный блок ПК Кузнецова</b>. Инвентарный номер: <b>PC-125987</b>'),
       (81, 1, '27.12.2014 14:05', 'admin',
        'Добавлен актив: <b>Монитор Монитор Кузнецова</b>. Инвентарный номер: <b>MON-124598</b>'),
       (82, 1, '27.12.2014 14:05', 'admin',
        'Добавлена КЕ: Рабочая станция Рабочее место Кузнецова. Инвентарный номер WS-156798. Дата ввода в эксплуатацию: 27.12.2014. Дата вывода из эксплуатации: '),
       (83, 1, '27.12.2014 14:09', 'admin',
        'Добавлен актив: <b>Клавиатура Logitech Black Keyboard</b>. Инвентарный номер: <b>KB-125798</b>'),
       (84, 1, '27.12.2014 14:09', 'admin',
        'Добавлен актив: <b>Мышь Logitech Black Mouse</b>. Инвентарный номер: <b>MOU-156798</b>'),
       (85, 1, '27.12.2014 14:09', 'admin',
        'Добавлен актив: <b>Операционная система Windows 8.1 Pro</b>. Инвентарный номер: <b></b>'),
       (86, 1, '24.11.2017 12:24', 'admin',
        'Изменен статус КЕ: <span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #fcb117\">В ремонте</span>'),
       (87, 1, '24.11.2017 12:24', 'admin',
       ...
       (89, 1, '25.11.2017 12:48', 'admin', 'Удален актив: <b> Windows 8.1 Pro</b>. Инвентарный номер: <b></b>'),
       (90, 1, '25.11.2017 12:48', 'admin',
        'Добавлен актив: <b>Операционная система Windows 8.1 Pro</b>. Инвентарный номер: <b></b>'),
       (91, 1, '28.11.2017 15:15', 'admin', 'Удален актив: <b> Windows 8.1 Pro</b>. Инвентарный номер: <b></b>'),
       (92, 1, '28.11.2017 15:15', 'admin',
        'Добавлен актив: <b>Операционная система Windows 8.1 Pro</b>. Инвентарный номер: <b></b>'),
       (93, 1, '07.12.2017 16:25', 'admin', 'Изменено описание: <b>asdsdasdas222</b>'),
       (94, 1, '06.05.2019 13:10', 'admin', 'Изменено описание: <b><p>asdsdasdas222</p></b>');
/*!40000 ALTER TABLE `uhistory`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ustatus`
    DISABLE KEYS */;
INSERT INTO `ustatus`
VALUES (1, 'Используется',
       ...
       (2, 'В ремонте',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #fcb117\">В ремонте</span>'),
       (3, 'В резерве',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #fcb117\">В резерве</span>'),
       (4, 'На складе',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #58595b\">На складе</span>'),
       (5, 'Списан',
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; background-color: #eb5f69\">Списан</span>');
/*!40000 ALTER TABLE `ustatus`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `zcategory`
    DISABLE KEYS */;
INSERT INTO `zcategory`
VALUES (1, 'Заявка на обслуживание', 1, 0),
       (2, 'Инцидент', 1, 1),
...
/*!40000 ALTER TABLE `zpriority`
    DISABLE KEYS */;
INSERT INTO `zpriority`
VALUES (1, 'Низкий', '+30', '+30', '+30'),
       (2, 'Средний', '+0', '+0', '+0'),
       (3, 'Высокий', '-30', '-30', '-30'),
...
/*!40000 ALTER TABLE `zstatus`
    DISABLE KEYS */;
INSERT INTO `zstatus`
VALUES (1, 'Открыта', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Открыта</span>',
        '#6ac28e', 1, 1, 1, 1, 0, 1, 0, 0, 'SMS или боты заявка открыта', 'Новая заказчик', 'default',
        'Новая исполнитель', 'Уведомление наблюдателя', 'default', 'default', 0, 0, 1, 'default', 'default', 1, 0, 0),
       (2, 'Открыта повторно', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #6ac28e; vertical-align: baseline; white-space: nowrap; border: 1px solid #6ac28e; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Открыта повторно</span>',
        '#6ac28e', 9, 0, 0, 1, 0, 0, 0, 0, 'default', 'default', 'default', 'Заявка открыта повторно', 'default',
        'default', 'default', 0, 0, 0, 'default', 'default', 4, 0, 0),
       (3, 'Принята в исполнение', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #5692bb; vertical-align: baseline; white-space: nowrap; border: 1px solid #5692bb; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Принята в исполнение</span>',
        '#5692bb', 2, 1, 1, 0, 0, 0, 0, 0, 'SMS или боты заявка принята', 'Заявка в работе заказчик', 'default',
        'Заявка в работе исполнитель', 'Уведомление наблюдателя', 'default', 'default', 0, 0, 0, 'default', 'default',
        2, 1, 0),
       (4, 'Просрочена реакция', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #fcb117; vertical-align: baseline; white-space: nowrap; border: 1px solid #fcb117; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Просрочена реакция</span>',
        '#fcb117', 4, 0, 0, 1, 0, 0, 0, 0, 'default', 'default', 'default', 'Просрочена реакция исполнитель',
        'Уведомление наблюдателя', 'default', 'default', 0, 0, 1, 'default', 'Скоро просрочена реакция', 6, 0, 0),
       (5, 'Просрочено исполнение', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #756994; vertical-align: baseline; white-space: nowrap; border: 1px solid #756994; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Просрочено исполнение</span>',
        '#756994', 5, 1, 0, 1, 0, 0, 0, 0, 'default', 'Просрочена заявка заказчик', 'default',
        'Просрочена заявка исполнитель', 'Уведомление наблюдателя', 'default', 'default', 0, 0, 1, 'default',
        'Скоро просрочено решение', 7, 0, 0),
       (6, 'Отменена', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #f56954; vertical-align: baseline; white-space: nowrap; border: 1px solid #f56954; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Отменена</span>',
        '#f56954', 6, 1, 0, 1, 0, 0, 0, 0, 'default', 'Заявка отменена', 'default', 'Заявка отменена',
        'Уведомление наблюдателя', 'default', 'default', 0, 0, 0, 'default', 'default', 5, 1, 0),
       (7, 'Требует уточнения', 0,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #39cccc; vertical-align: baseline; white-space: nowrap; border: 1px solid #39cccc; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Требует уточнения</span>',
        '#39cccc', 8, 1, 0, 0, 0, 0, 0, 0, 'default', 'default', 'default', 'default', 'Уведомление наблюдателя',
        'default', 'default', 0, 1, 0, 'default', 'default', 8, 0, 0),
       (8, 'Требует согласования', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #001f3f; vertical-align: baseline; white-space: nowrap; border: 1px solid #001f3f; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Требует согласования</span>',
        '#001f3f', 7, 0, 0, 0, 0, 0, 1, 0, 'default', 'default', 'default', 'default', 'Уведомление наблюдателя',
        'Заявка требует согласования', 'default', 0, 0, 0, 'default', 'default', 8, 0, 0),
       (9, 'Согласовано', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #ff851b; vertical-align: baseline; white-space: nowrap; border: 1px solid #ff851b; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Согласовано</span>',
        '#ff851b', 0, 0, 0, 1, 0, 0, 0, 0, 'default', 'default', 'default', 'Заявка согласована', 'default', 'default',
        'default', 0, 0, 0, 'default', 'default', 9, 0, 0),
       (10, 'Выполнена', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #d81b60; vertical-align: baseline; white-space: nowrap; border: 1px solid #d81b60; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Выполнена</span>',
        '#d81b60', 0, 1, 0, 0, 0, 0, 0, 0, 'default', 'Заявка завершена', 'default', 'default', 'default', 'default',
        'default', 0, 0, 0, 'default', 'default', 10, 0, 0),
       (11, 'Завершена', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #58595b; vertical-align: baseline; white-space: nowrap; border: 1px solid #58595b; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Завершена</span>',
        '#58595b', 3, 1, 1, 0, 0, 1, 0, 0, 'SMS или боты заявка закрыта', 'Заявка завершена', 'default',
        'Заявка завершена', 'Заявка завершена', 'default', 'default', 0, 0, 0, 'default', 'default', 3, 1, 0),
       (12, 'Приостановлена', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #248f8f; vertical-align: baseline; white-space: nowrap; border: 1px solid #248f8f; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Приостановлена</span>',
        '#248f8f', 10, 1, 0, 1, 0, 0, 0, 0, 'default', 'Заявка приостановлена', 'default', 'Заявка приостановлена',
        'Заявка приостановлена', 'default', 'default', 0, 1, 0, 'default', 'default', 11, 1, 0),
       (13, 'Архив', 1,
        '<span style=\"display: inline-block; padding: 2px 4px; font-size: 11.844px; font-weight: bold; line-height: 14px; color: #8fc763; vertical-align: baseline; white-space: nowrap; border: 1px solid #8fc763; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;\">Архив</span>',
        '#8fc763', 0, 0, 0, 0, 0, 0, 0, 0, 'default', 'default', 'default', 'default', 'default', 'default', 'default',
        1, 1, 0, 'default', 'default', 0, 0, 0);
/*!40000 ALTER TABLE `zstatus`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `zstatus_to_roles`
    DISABLE KEYS */;
INSERT INTO `zstatus_to_roles`
VALUES (1, 1),
       (1, 2),
       (1, 3),
       (2, 1),
...
-- Dump completed on 2019-11-29 10:18:34
