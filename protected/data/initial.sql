...
('1','admin','Администратор','b147fdcfe0a8120780ce85a8a6d27596','admin@email.com','+79003113133','','2222','vsdeskadmin','Администратор','Users Company','','ИТ отдел','','','','1','0','ru');
INSERT INTO `CUsers` (`id`,`Username`,`fullname`,`Password`,`Email`,`Phone`,`push_id`,`intphone`,`role`,`role_name`,`company`,`room`,`department`,`umanager`,`birth`,`position`,`sendmail`,`sendsms`,`lang`) VALUES
('2','manager','Васин В.В.','9a88fba853317e9496ca33824bda8ba8','manager@email.com','+79005556667','','','vsdeskmanager','Исполнитель','Managers company','','ИТ отдел','','','Инженер','1','0','ru');
INSERT INTO `CUsers` (`id`,`Username`,`fullname`,`Password`,`Email`,`Phone`,`push_id`,`intphone`,`role`,`role_name`,`company`,`room`,`department`,`umanager`,`birth`,`position`,`sendmail`,`sendsms`,`lang`) VALUES
('3','user','Кузнецов А.С.','4417e18f1155c1f595e1006aed7d2e27','user@email.com','+79000345567','','','vsdeskuser','Пользователь','Users Company','205','Отдел продаж','','','Менеджер','1','0','ru');
...
('1','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#5692bb;\">info</span>','MAIL_SEND','07.05.2016 11:17','IP:[127.0.0.1] Сообщение \"[Ticket #1] Тестовая заявка\" для i@aivanov.pro было успешно отправлено.');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('2','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#5692bb;\">info</span>','MAIL_SEND','07.05.2016 11:17','IP:[127.0.0.1] Сообщение \"[Ticket #1] Тестовая заявка\" для support@vsdesk.ru было успешно отправлено.');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('3','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#6ac28e;\">created</span>','CREATED','07.05.2016 11:17','IP:[127.0.0.1] User user create new ticket #1 named \"Тестовая заявка\"');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('4','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:19','IP:[127.0.0.1] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для user@email.com: Ошибка соединения с SMTP-сервером');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('5','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:19','IP:[127.0.0.1] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для manager@email.com: Ошибка соединения с SMTP-сервером');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('6','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:32','IP:[188.35.130.77] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для user@email.com: Ошибка соединения с SMTP-сервером');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('7','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:32','IP:[188.35.130.77] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для manager@email.com: Ошибка соединения с SMTP-сервером');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('8','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#756994;\">updated</span>','UPDATED','09.09.2016 21:32','IP:[188.35.130.77] User admin updated ticket #1 named \"Тестовая заявка\"');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('9','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:35','IP:[127.0.0.1] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для user@email.com: Ошибка соединения с SMTP-сервером');
INSERT INTO `YiiLog` (`id`,`level`,`category`,`logtime`,`message`) VALUES
('10','<span style=\"padding:2px 4px;font-size:11.844px;font-weight:bold;line-height:14px;color:#ffffff;vertical-align:baseline;white-space:nowrap;background-color:#eb5f69;\">error</span>','MAIL_ERR','09.09.2016 21:35','IP:[127.0.0.1] Получена ошибка при отправке сообщения \"[Ticket #1] Тестовая заявка\" для manager@email.com: Ошибка соединения с SMTP-сервером');
...
('1','Автоматическая обработка статусов заявок по расписанию','1','php /var/www/vsdesk.debian7.standard.local/protected/cron.php getstatus >/dev/null 2>&1','*/5 * * * *');
INSERT INTO `cron` (`id`,`name`,`job_id`,`job`,`time`) VALUES
('2','Автоматическая проверка IMAP ящика для создания заявок','2','php /var/www/vsdesk.debian7.standard.local/protected/cron.php getmail >/dev/null 2>&1 ','*/5 * * * *');
INSERT INTO `cron` (`id`,`name`,`job_id`,`job`,`time`) VALUES
('3','Автоматическое резервное копирование БД','3','php /var/www/vsdesk.debian7.standard.local/protected/cron.php backup >/dev/null 2>&1 ','30 22 * * 5');
INSERT INTO `cron` (`id`,`name`,`job_id`,`job`,`time`) VALUES
('5','Автоматический импорт пользователей из Active Directory','5','php /var/www/vsdesk.debian7.standard.local/protected/cron.php syncusers >/dev/null 2>&1 ','0 */1 * * *');
