...
$this->menu=array(
array('icon' => 'iicon iicon-plus-circle iicon-2x', 'url' => array('create'), 'itemOptions'=>array('title' => Yii::t('main-ui', 'Create'))),
);

?>
<div class="page-header">
    <h3><i class="iicon iicon-list iicon-2x"> </i><?php echo "<?php echo"; ?> Yii::t('main-ui', '<?php echo $label; ?>');?></h3>
...
<div class="box">
    <div class="box-body table-responsive">
        ...
        'template' => $dialog->link($text = '<i class="iicon iicon-cog"> ' . Yii::t('main-ui', 'Columns settings') . '</i>') .
        "{summary}\n{items}\n{pager}",
        )); ?>
    </div>
</div>
