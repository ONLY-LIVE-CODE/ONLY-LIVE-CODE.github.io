	...
	public function up()
	{
		$tableOptions = 'CHARACTER SET utf8 COLLATE utf8_general_ci';
				...
				foreach ($req as $value) {
					...
					// 	Request::model()->updateByPk($value->id, array('channel' => 'Email', 'channel_icon' => 'iicon iicon-envelope'));
					// } elseif($value->ZayavCategory_id == 'Telegram ticket'){
					// 	Request::model()->updateByPk($value->id, array('channel' => 'Telegram', 'channel_icon' => 'iicon iicon-paper-plane'));
					// } elseif($value->ZayavCategory_id == 'Portal ticket' OR $value->ZayavCategory_id == 'Заявка с портала'){
					// 	Request::model()->updateByPk($value->id, array('channel' => 'Portal', 'channel_icon' => 'iicon iicon-home'));
					// } else {
					// 	Request::model()->updateByPk($value->id, array('channel' => 'Manual', 'channel_icon' => 'iicon iicon-pencil-line'));
					// }
				}
	}
